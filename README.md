# 🚀 SPARK Workshop Series
		...
		items={[
			...
			{title: 'Saeid Amini', description: 'Isfahan University, Iran'},
			{title: 'Robert Blackwell', description: 'The Turing Institute, UK'},
			{title: 'Tony Cohn', description: 'University of Leeds'},
			{title: 'Elena Demidova', description: 'University of Bonn'},
			{title: 'Simon Gottschalk', description: 'L3S, Leibniz University Hannover'},
			{title: 'Krzysztof Janowicz', description: 'University of Vienna'},
			{title: 'Mehrdad Koohikamali', description: 'California State Polytechnic University, USA'},
			{title: 'Shain Mohammad', description: 'Chamran University, Iran'},
			{title: 'Mina Sadeghi', description: 'K.N. Toosi University, Iran'},
			{title: 'Hannah Schuster', description: 'WU Vienna, Austria'},
			{title: 'Shahrom Sohi', description: 'WU Vienna, Austria'},
			{title: 'Cogan Shimizu', description: 'Wright State University, USA'},
			{title: 'Dimitris Skoutas', description: 'ATHENA Research Center, Greece'},
			{title: 'Rui Zhu', description: 'University of Bristol, UK'},
